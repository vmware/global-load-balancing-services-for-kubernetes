...
var gslbhostrulesResource = v1alpha1.SchemeGroupVersion.WithResource("gslbhostrules")

var gslbhostrulesKind = v1alpha1.SchemeGroupVersion.WithKind("GSLBHostRule")
