...
func addGSLBTestConfigObject(obj interface{}) {
	...
	fooCtrl := GetGSLBMemberController("cluster1", fooInformerInstance)
	...
	barCtrl := GetGSLBMemberController("cluster2", barInformerInstance)
...
func TestGDPNewController(t *testing.T) {
	...
	gdpCtrl := InitializeGDPController(gdpKubeClient, gdpClient, gdpInformerFactory, addSomething, updateSomething,
		addSomething)
	if gdpCtrl == nil {
