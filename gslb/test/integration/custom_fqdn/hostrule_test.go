...
func TestHRCreate(t *testing.T) {
	...
	g.Eventually(func() bool {
		return verifyGSMembers(t, expectedMembers, gfqdn, gslbutils.GetAviConfig().Tenant, hmRefs, nil, nil,
...
func TestHostRuleCreateWithHmTemplateInGDP(t *testing.T) {
	...
	expectedMembers = append(expectedMembers, getTestGSMemberFromIng(t, ingObj, ingCluster, 1))
	g.Eventually(func() bool {
		return verifyGSMembers(t, expectedMembers, gfqdn, gslbutils.GetAviConfig().Tenant, nil, nil, nil,
...
func TestHRCreateUnsetIncludeAliases(t *testing.T) {
	...
	expectedMembers = append(expectedMembers, getTestGSMemberFromIng(t, ingObj, ingCluster, 1))
	g.Eventually(func() bool {
		return verifyGSMembers(t, expectedMembers, gfqdn, gslbutils.GetAviConfig().Tenant, hmRefs, nil, nil, defaultDomainNames)
	}, 5*time.Second, 1*time.Second).Should(gomega.Equal(true))
...
func TestHRRemoveAliases(t *testing.T) {
	...
	g.Eventually(func() bool {
		return verifyGSMembers(t, expectedMembers, gfqdn, gslbutils.GetAviConfig().Tenant, hmRefs, nil, nil, []string{gfqdn})
	}, 5*time.Second, 1*time.Second).Should(gomega.Equal(true))
}
...
func TestHRCreateUpdateGfdnDelete(t *testing.T) {
	...
	g.Eventually(func() bool {
		return verifyGSMembers(t, expectedMembers, newgfqdn, gslbutils.GetAviConfig().Tenant, hmRefs, nil, nil,
...
func TestHRCreateUpdateGfdnDeleteUnsetIncludeAliases(t *testing.T) {
	...
	g.Eventually(func() bool {
		return verifyGSMembers(t, expectedMembers, newgfqdn, gslbutils.GetAviConfig().Tenant, hmRefs, nil, nil, defaultDomainNames)
	}, 5*time.Second, 1*time.Second).Should(gomega.Equal(true))
...
func TestHRCreateUpdateDuplicateAliasesInCluster(t *testing.T) {
	...
	expectedMembers = append(expectedMembers, getTestGSMemberFromIng(t, ingObj, ingCluster, 1))
	g.Eventually(func() bool {
		return verifyGSMembers(t, expectedMembers, gfqdn, gslbutils.GetAviConfig().Tenant, hmRefs, nil, nil, getDefaultExpectedDomainNames(gfqdn, []*akov1alpha1.HostRule{k8sHr}))
	}, 5*time.Second, 1*time.Second).Should(gomega.Equal(true))
	...
	expectedMembers = append(expectedMembers, getTestGSMemberFromRoute(t, routeObj, routeCluster, 1))
	g.Eventually(func() bool {
		return verifyGSMembers(t, expectedMembers, gfqdn, gslbutils.GetAviConfig().Tenant, hmRefs, nil, nil, getDefaultExpectedDomainNames(gfqdn, []*akov1alpha1.HostRule{k8sHr, ocHr}))
	}, 5*time.Second, 1*time.Second).Should(gomega.Equal(true))
	...
	g.Eventually(func() bool {
		return verifyGSMembers(t, expectedMembers, gfqdn, gslbutils.GetAviConfig().Tenant, hmRefs, nil, nil, getDefaultExpectedDomainNames(gfqdn, []*akov1alpha1.HostRule{ocHr}))
	}, 5*time.Second, 1*time.Second).Should(gomega.Equal(true))
...
func TestHostRuleMultipleForCustomFqdn(t *testing.T) {
	...
	expectedMembers = append(expectedMembers, getTestGSMemberFromIng(t, ingObj, ingCluster, 1))
	g.Eventually(func() bool {
		return verifyGSMembers(t, expectedMembers, gfqdn1, gslbutils.GetAviConfig().Tenant, hmRefs, nil, nil,
