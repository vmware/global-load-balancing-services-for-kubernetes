...
func (mciHostMeta MultiClusterIngressHostMeta) GetOldTenant() string {
	return mciHostMeta.OldTenant
}
...
func (mciHostMeta MultiClusterIngressHostMeta) GetIngressHostCksum() uint32 {
	...
	cksum += utils.Hash(mciHostMeta.Cluster) + utils.Hash(mciHostMeta.Namespace) +
		...
		utils.Hash(mciHostMeta.Tenant) + utils.Hash(mciHostMeta.OldTenant)
	return cksum
}
