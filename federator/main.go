...
import (
	...
	"github.com/vmware/global-load-balancing-services-for-kubernetes/federator/controllers"
...
func init() {
	...
	utilruntime.Must(amkovmwarecomv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "df892bb6.github.com",
	})
	if err != nil {
	...
	if err = (&controllers.AMKOClusterReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "AMKOCluster")
		os.Exit(1)
	}
