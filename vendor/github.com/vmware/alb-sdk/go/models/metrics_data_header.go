...
type MetricsDataHeader struct {
	...
	// Metrics derivation info. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// statistics of the metric. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
