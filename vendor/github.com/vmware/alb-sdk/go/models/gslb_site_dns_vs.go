...
type GslbSiteDNSVs struct {
	...
	// This field identifies the DNS VS uuid for this site. Field introduced in 17.2.3. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	// Required: true
