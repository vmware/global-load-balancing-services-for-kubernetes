...
type Http2PoolProperties struct {
	...
	// The maximum size in bytes of the compressed request header field. The limit applies equally to both name and value. Allowed values are 1-8192. Field introduced in 21.1.1. Unit is BYTES. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
