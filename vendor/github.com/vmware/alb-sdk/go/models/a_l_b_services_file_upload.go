...
type ALBServicesFileUpload struct {
	...
	// Salesforce alphanumeric CaseID to attach uploaded file to. Field introduced in 18.2.6. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	CaseID *string `json:"case_id,omitempty"`

	// Error reported during file upload. Field introduced in 18.2.6. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	// Read Only: true
	Error *string `json:"error,omitempty"`

	// Stores output file path, for upload to AWS S3. Field introduced in 18.2.6. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	// Required: true
	...
	// Custom AWS S3 Directory Path to upload file. Field introduced in 18.2.6. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
