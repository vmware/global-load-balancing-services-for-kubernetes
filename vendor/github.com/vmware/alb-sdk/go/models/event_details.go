...
type EventDetails struct {
	...
	//  Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	ApiserverRequestQueueFullEventInfo *RequestLimiterEventInfo `json:"apiserver_request_queue_full_event_info,omitempty"`

	//  Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	ApiserverRequestQueueRecoveryEventInfo *RequestLimiterEventInfo `json:"apiserver_request_queue_recovery_event_info,omitempty"`
	...
	// Azure marketplace license term acceptance event. Field introduced in 18.2.2. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	//  Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	PostgresEventDetails *PostgresEventInfo `json:"postgres_event_details,omitempty"`
	...
	//  Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	VsConfigSedatastoreDlFail *SeVsConfigSeDatastoreDownloadFailed `json:"vs_config_sedatastore_dl_fail,omitempty"`
