...
type MustChecksInfo struct {
	...
	// Reason for must check failure. Field introduced in 22.1.3. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
	Description *string `json:"description,omitempty"`

	// Additional details of the must check. Field introduced in 22.1.3. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
	Details []string `json:"details,omitempty"`

	// Time taken to complete must check in seconds. Field introduced in 22.1.3. Unit is SEC. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
	Duration *uint32 `json:"duration,omitempty"`

	// Time at which execution of must check was completed. Field introduced in 22.1.3. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
	...
	// Time at which execution of must check was started. Field introduced in 22.1.3. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
