...
type PathMatch struct {
	...
	// Case sensitivity to use for the matching. Enum options - SENSITIVE, INSENSITIVE. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Match against the decoded URI path. Field introduced in 22.1.3. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
	MatchDecodedString *bool `json:"match_decoded_string,omitempty"`

	// String values. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
