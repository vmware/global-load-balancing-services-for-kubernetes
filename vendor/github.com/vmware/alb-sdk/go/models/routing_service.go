...
type RoutingService struct {
	...
	// Advertise reachability of backend server networks via ADC through BGP for default gateway feature. Field introduced in 18.2.5. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	AdvertiseBackendNetworks *bool `json:"advertise_backend_networks,omitempty"`

	// Enable auto gateway to save and use the same L2 path to send the return traffic. Field introduced in 20.1.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	EnableAutoGateway *bool `json:"enable_auto_gateway,omitempty"`

	// Service Engine acts as Default Gateway for this service. Field introduced in 18.2.5. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	EnableRouting *bool `json:"enable_routing,omitempty"`

	// Enable VIP on all interfaces of this service. Field introduced in 18.2.5. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	EnableVipOnAllInterfaces *bool `json:"enable_vip_on_all_interfaces,omitempty"`

	// Use Virtual MAC address for interfaces on which floating interface IPs are placed. Field introduced in 18.2.5. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	EnableVMAC *bool `json:"enable_vmac,omitempty"`

	// Floating Interface IPs for the RoutingService. Field introduced in 18.2.5. Maximum of 32 items allowed. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	FloatingIntfIP []*IPAddr `json:"floating_intf_ip,omitempty"`

	// IPv6 Floating Interface IPs for the RoutingService. Field introduced in 22.1.6, 30.2.1. Maximum of 32 items allowed. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
	...
	// Routing Service related Flow profile information. Field introduced in 18.2.5. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	FlowtableProfile *FlowtableProfile `json:"flowtable_profile,omitempty"`

	// Enable graceful restart feature in routing service. For example, BGP. Field introduced in 18.2.6. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	GracefulRestart *bool `json:"graceful_restart,omitempty"`

	// NAT policy for outbound NAT functionality. This is done in post-routing. It is a reference to an object of type NatPolicy. Field introduced in 18.2.5. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
