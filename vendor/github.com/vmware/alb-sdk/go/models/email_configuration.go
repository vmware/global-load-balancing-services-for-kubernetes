...
type EmailConfiguration struct {
	...
	// Password for mail server. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	AuthPassword *string `json:"auth_password,omitempty"`

	// Username for mail server. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	AuthUsername *string `json:"auth_username,omitempty"`

	// When set, disables TLS on the connection to the mail server. Field introduced in 17.2.12, 18.1.3, 18.2.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Email address in From field. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	FromEmail *string `json:"from_email,omitempty"`

	// Friendly name in From field. Field introduced in 21.1.4, 22.1.3. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
