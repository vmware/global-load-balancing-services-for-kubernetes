...
type LogMgrUberEventDetails struct {
	...
	//  Enum options - X_ENUM_1, X_ENUM_2, X_ENUM_3, X_ENUM_4. Field introduced in 30.2.1. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
