...
type CloudInfo struct {
	...
	// CloudConnectorAgent properties specific to this cloud type. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	CcaProps *CCAgentProperties `json:"cca_props,omitempty"`

	// Controller properties specific to this cloud type. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	ControllerProps *ControllerProperties `json:"controller_props,omitempty"`

	// Flavor properties specific to this cloud type. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Supported hypervisors. Enum options - DEFAULT, VMWARE_ESX, KVM, VMWARE_VSAN, XEN. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
