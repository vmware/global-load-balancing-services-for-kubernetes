...
type WafExcludeListEntry struct {
	...
	// Client IP Subnet to exclude for WAF rules. Field introduced in 17.2.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	ClientSubnet *IPAddrPrefix `json:"client_subnet,omitempty"`

	// Free-text comment about this exclusion. Field introduced in 18.2.6. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Criteria for match_element matching. Field introduced in 18.2.2. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	MatchElementCriteria *WafExclusionType `json:"match_element_criteria,omitempty"`

	// Criteria for URI matching. Field introduced in 17.2.8. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	URIMatchCriteria *WafExclusionType `json:"uri_match_criteria,omitempty"`

	// URI Path to exclude for WAF rules. Field introduced in 17.2.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
