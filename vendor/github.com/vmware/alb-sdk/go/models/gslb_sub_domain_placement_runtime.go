...
type GslbSubDomainPlacementRuntime struct {
	...
	// This field identifies the Subdomain. Field introduced in 17.2.3. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
