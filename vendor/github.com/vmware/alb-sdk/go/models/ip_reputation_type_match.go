...
type IPReputationTypeMatch struct {
	...
	// Match criteria. Enum options - IS_IN, IS_NOT_IN. Field introduced in 20.1.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	// Required: true
