...
type MetricsMgrDebugFilter struct {
	...
	// Setting to reduce the grace period for license expiry in hours. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
