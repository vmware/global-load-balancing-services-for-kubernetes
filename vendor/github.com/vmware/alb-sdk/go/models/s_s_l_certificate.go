...
type SSLCertificate struct {
	...
	// Valid range  1-3650. Allowed values are 1-3650. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	DaysUntilExpire *int32 `json:"days_until_expire,omitempty"`

	//  Enum options - SSL_CERTIFICATE_GOOD, SSL_CERTIFICATE_EXPIRY_WARNING, SSL_CERTIFICATE_EXPIRED. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// subjectAltName that provides additional subject identities. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
