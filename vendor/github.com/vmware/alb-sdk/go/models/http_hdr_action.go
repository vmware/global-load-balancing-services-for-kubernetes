...
type HTTPHdrAction struct {
	...
	// Cookie information. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	Cookie *HTTPCookieData `json:"cookie,omitempty"`

	// HTTP header information. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
