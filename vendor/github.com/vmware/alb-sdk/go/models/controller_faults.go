...
type ControllerFaults struct {
	...
	// Enable backup scheduler faults. Field introduced in 20.1.6. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
	BackupSchedulerFaults *bool `json:"backup_scheduler_faults,omitempty"`

	// Enable cluster faults. Field introduced in 20.1.6. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
	ClusterFaults *bool `json:"cluster_faults,omitempty"`

	// Enable deprecated api version faults. Field introduced in 20.1.6. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
	DeprecatedAPIVersionFaults *bool `json:"deprecated_api_version_faults,omitempty"`

	// Enable license faults. Field introduced in 20.1.6. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
	LicenseFaults *bool `json:"license_faults,omitempty"`

	// Enable DB migration faults. Field introduced in 20.1.6. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
