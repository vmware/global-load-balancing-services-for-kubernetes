...
type ApplicationLog struct {
	...
	// List of ciphers sent by client in TLS Client Hello. This field is only generated when TLS handshake fails due to no shared cipher. Field introduced in 18.1.4, 18.2.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// IPv4 address of the client. When true client IP feature is enabled, this will be derived from the header configured in the true client IP feature, if present in the request. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	// Required: true
	ClientIP *uint32 `json:"client_ip"`

	// IPv6 address of the client. Field introduced in 18.1.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	ClientIp6 *string `json:"client_ip6,omitempty"`

	//  Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	ClientLocation *string `json:"client_location,omitempty"`

	// Name of the Client Log Filter applied. Field introduced in 18.1.5, 18.2.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Log created by the invocations of the DataScript api avi.vs.log(). Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	DatascriptLog *string `json:"datascript_log,omitempty"`

	//  Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	Etag *string `json:"etag,omitempty"`

	// The method called by the gRPC request. Field introduced in 20.1.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	GrpcMethodName *string `json:"grpc_method_name,omitempty"`

	// The service called by the gRPC request. Field introduced in 20.1.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	GrpcServiceName *string `json:"grpc_service_name,omitempty"`

	// GRPC response status sent in the GRPC trailer. Special values are -1- No GRPC status recevied even though client sent content-type as application/grpc.. Field introduced in 20.1.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Response headers received from backend server. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	HeadersReceivedFromServer *string `json:"headers_received_from_server,omitempty"`

	// Request headers sent to backend server. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	HeadersSentToServer *string `json:"headers_sent_to_server,omitempty"`

	//  Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	Host *string `json:"host,omitempty"`

	// Stream identifier corresponding to an HTTP2 request. Field introduced in 18.1.2. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Unique HTTP Request ID . Field introduced in 17.2.4. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Flag to indicate if request was served locally because the remote site was down. Field introduced in 17.2.5. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// SAML authentication request is generated. Field introduced in 18.2.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	SamlAuthRequestGenerated *bool `json:"saml_auth_request_generated,omitempty"`

	// SAML authentication response is received. Field introduced in 18.2.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	SamlAuthResponseReceived *bool `json:"saml_auth_response_received,omitempty"`

	// SAML authentication session ID. Field introduced in 18.2.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	SamlAuthSessionID *uint64 `json:"saml_auth_session_id,omitempty"`

	// SAML authentication is used. Field introduced in 18.2.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	SamlAuthenticationUsed *bool `json:"saml_authentication_used,omitempty"`

	// Logs for the SAML authentication/authorization process. Field introduced in 20.1.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	SamlLog *SamlLog `json:"saml_log,omitempty"`

	// SAML authentication session cookie is valid. Field introduced in 18.2.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// IPv6 address used to connect to Server. Field introduced in 18.1.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	ServerConnSrcIp6 *string `json:"server_conn_src_ip6,omitempty"`

	// Flag to indicate if connection from the connection pool was reused. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// IPv6 address of the Server. Field introduced in 18.1.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// SSL session id for the backend connection. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	ServerSslSessionID *string `json:"server_ssl_session_id,omitempty"`

	// Flag to indicate if SSL session was reused. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	ServerSslSessionReused *bool `json:"server_ssl_session_reused,omitempty"`

	// Number of servers tried during server reselect before the response is sent back. Field introduced in 18.2.2. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Virtual IPv6 address of the VS. Field introduced in 18.1.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	VsIp6 *string `json:"vs_ip6,omitempty"`

	// Presence of waf_log indicates that atleast 1 WAF rule was hit for the transaction. Field introduced in 17.2.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
