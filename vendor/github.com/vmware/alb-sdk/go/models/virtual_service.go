...
type VirtualService struct {
	...
	// The name of the Contract/Graph associated with the Virtual Service. Should be in the <Contract name> <Graph name> format. This is applicable only for Service Integration mode with Cisco APIC Controller . Field deprecated in 21.1.1. Field introduced in 17.2.12,18.1.2. Allowed in Basic edition, Essentials edition, Enterprise edition.
