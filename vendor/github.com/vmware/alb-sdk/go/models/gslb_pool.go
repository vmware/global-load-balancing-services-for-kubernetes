...
type GslbPool struct {
	...
	// Mask to be applied on client IP for consistent hash algorithm. Allowed values are 1-31. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	ConsistentHashMask *uint32 `json:"consistent_hash_mask,omitempty"`

	// Mask to be applied on client IPV6 address for consistent hash algorithm. Allowed values are 1-127. Field introduced in 18.2.8, 20.1.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	ConsistentHashMask6 *uint32 `json:"consistent_hash_mask6,omitempty"`

	// User provided information that records member details such as application owner name, contact, etc. Field introduced in 17.1.3. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	Description *string `json:"description,omitempty"`

	// Enable or disable a GSLB service pool. Field introduced in 17.2.14, 18.1.5, 18.2.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Manually resume traffic to a pool member once it goes down. If enabled a pool member once goes down is kept in admin down state unless admin re enables it. Field introduced in 22.1.3. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
	ManualResume *bool `json:"manual_resume,omitempty"`

	// Select list of VIPs belonging to this GSLB service. Minimum of 1 items required. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	Members []*GslbPoolMember `json:"members,omitempty"`

	// Minimum number of health monitors in UP state to mark the member UP. Field introduced in 20.1.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	MinHealthMonitorsUp *uint32 `json:"min_health_monitors_up,omitempty"`

	// Name of the GSLB service pool. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	// Required: true
