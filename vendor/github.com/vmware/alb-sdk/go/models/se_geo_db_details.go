...
type SeGeoDbDetails struct {
	...
	// Geo Db file name. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	FileName *string `json:"file_name,omitempty"`

	// Name of the Gslb Geo Db Profile. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	GeoDbProfileName *string `json:"geo_db_profile_name,omitempty"`

	// UUID of the Gslb Geo Db Profile. It is a reference to an object of type GslbGeoDbProfile. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	GeoDbProfileRef *string `json:"geo_db_profile_ref,omitempty"`

	// Reason for Gslb Geo Db failure. Enum options - NO_ERROR, FILE_ERROR, FILE_FORMAT_ERROR, FILE_NO_RESOURCES. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
