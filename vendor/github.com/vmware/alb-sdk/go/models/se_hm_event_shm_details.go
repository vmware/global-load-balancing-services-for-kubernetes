...
type SeHmEventShmDetails struct {
	...
	// Health Monitor name. It is a reference to an object of type HealthMonitor. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	// Required: true
	...
	// Response code from server. Field introduced in 17.2.4. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
