...
type ControllerInterface struct {
	...
	// IPv4 default gateway of the interface. Field introduced in 21.1.3. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
	Gateway *IPAddr `json:"gateway,omitempty"`

	// IPv6 default gateway of the interface. Field introduced in 22.1.3. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
	...
	// IPv4 prefix of the interface. Field introduced in 21.1.3. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
	IP *IPAddrPrefix `json:"ip,omitempty"`

	// IPv6 prefix of the interface. Field introduced in 22.1.3. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
	...
	// Public IP of interface. Field introduced in 21.1.3. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
