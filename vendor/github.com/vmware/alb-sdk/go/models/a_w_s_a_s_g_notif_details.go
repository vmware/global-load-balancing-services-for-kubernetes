...
type AWSASGNotifDetails struct {
	...
	// UUID of the Pool. It is a reference to an object of type Pool. Field introduced in 17.2.3. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
