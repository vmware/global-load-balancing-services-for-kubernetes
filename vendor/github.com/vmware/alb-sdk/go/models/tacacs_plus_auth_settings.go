...
type TacacsPlusAuthSettings struct {
	...
	// TACACS+ authorization attribute value pairs. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	AuthorizationAttrs []*AuthTacacsPlusAttributeValuePair `json:"authorization_attrs,omitempty"`

	// TACACS+ server shared secret. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	Password *string `json:"password,omitempty"`

	// TACACS+ server listening port. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	Port *uint32 `json:"port,omitempty"`

	// TACACS+ server IP address or FQDN. Minimum of 1 items required. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
