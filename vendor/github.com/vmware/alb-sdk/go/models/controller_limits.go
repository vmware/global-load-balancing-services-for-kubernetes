...
type ControllerLimits struct {
	...
	// Controller system limits specific to cloud type for all controller sizes. Field introduced in 20.1.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	ControllerCloudLimits []*ControllerCloudLimits `json:"controller_cloud_limits,omitempty"`

	// Controller system limits specific to controller sizing. Field introduced in 20.1.1. Maximum of 4 items allowed. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Maximum number of pools per poolgroup. Field introduced in 20.1.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	PoolsPerPoolgroup *int32 `json:"pools_per_poolgroup,omitempty"`

	// Maximum number of pools per virtualservice. Field introduced in 20.1.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Maximum number of servers per pool. Field introduced in 20.1.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	ServersPerPool *int32 `json:"servers_per_pool,omitempty"`

	// Maximum number of SNI children virtualservices per SNI parent virtualservice. Field introduced in 20.1.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	SniChildrenPerParent *int32 `json:"sni_children_per_parent,omitempty"`

	// Maximum number of strings per stringgroup. Field introduced in 20.1.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	StringsPerStringgroup *int32 `json:"strings_per_stringgroup,omitempty"`

	// Maximum number of serviceengine per virtualservice in bgp scaleout mode. Field introduced in 20.1.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
