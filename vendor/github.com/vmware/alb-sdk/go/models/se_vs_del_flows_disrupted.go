...
type SeVsDelFlowsDisrupted struct {
	...
	// Name of the VS which was deleted from the SE. It is a reference to an object of type VirtualService. Field introduced in 22.1.1. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
	DeletedVsName *string `json:"deleted_vs_name,omitempty"`

	// Number of VS flows disrupted when VS was deleted from the SE. Field introduced in 22.1.1. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
