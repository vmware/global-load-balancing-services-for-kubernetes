...
type AppLearningParams struct {
	...
	// [Deprecated] If Bot detection is active for this Virtual Service, learning will only be performed on requests from clients within the configured bot classification types. Field deprecated in 31.2.1. Field introduced in 30.2.1. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
