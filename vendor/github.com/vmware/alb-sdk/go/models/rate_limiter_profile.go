...
type RateLimiterProfile struct {
	...
	// Rate Limit all connections made from any single client IP address to the Virtual Service. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Rate Limit all HTTP requests from any single client IP address to all URLs of the Virtual Service. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Rate Limit all HTTP requests from any single client IP address to any single URL. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	ClientIPToURIRequestsRateLimit *RateProfile `json:"client_ip_to_uri_requests_rate_limit,omitempty"`

	// Rate Limit all HTTP requests that map to any custom string. Field introduced in 17.2.13,18.1.3,18.2.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	CustomRequestsRateLimit *RateProfile `json:"custom_requests_rate_limit,omitempty"`

	// Rate Limit all HTTP requests from all client IP addresses that contain any single HTTP header value. Field introduced in 17.1.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Rate Limit all HTTP requests from all client IP addresses to any single URL. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
