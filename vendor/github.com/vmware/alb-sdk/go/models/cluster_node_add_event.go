...
type ClusterNodeAddEvent struct {
	...
	// Role of the controller within the cluster. Enum options - CLUSTER_LEADER, CLUSTER_FOLLOWER, CLUSTER_UNKNOWN. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
