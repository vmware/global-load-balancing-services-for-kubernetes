...
type HTTPApplicationProfile struct {
	...
	// Allow use of dot (.) in HTTP header names, for instance Header.app.special  PickAppVersionX. Allowed with any value in Enterprise, Enterprise with Cloud Services edition. Allowed in Essentials (Allowed values- false), Basic (Allowed values- false) edition.
	AllowDotsInHeaderName *bool `json:"allow_dots_in_header_name,omitempty"`

	// HTTP Caching config to use with this HTTP Profile. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
	CacheConfig *HTTPCacheConfig `json:"cache_config,omitempty"`

	// The maximum length of time allowed between consecutive read operations for a client request body. The value '0' specifies no timeout. This setting generally impacts the length of time allowed for a client to send a POST. Allowed values are 0-100000000. Unit is MILLISECONDS. Allowed with any value in Enterprise, Basic, Enterprise with Cloud Services edition. Allowed in Essentials (Allowed values- 30000) edition.
	ClientBodyTimeout *int32 `json:"client_body_timeout,omitempty"`

	// The maximum length of time allowed for a client to transmit an entire request header. This helps mitigate various forms of SlowLoris attacks. Allowed values are 10-100000000. Unit is MILLISECONDS. Allowed with any value in Enterprise, Enterprise with Cloud Services edition. Allowed in Essentials (Allowed values- 10000), Basic (Allowed values- 10000) edition.
	ClientHeaderTimeout *int32 `json:"client_header_timeout,omitempty"`

	// Maximum size for the client request body.  This limits the size of the client data that can be uploaded/posted as part of a single HTTP Request.  Default 0 => Unlimited. Unit is KB. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	ClientMaxBodySize *int64 `json:"client_max_body_size,omitempty"`

	// Maximum size in Kbytes of a single HTTP header in the client request. Allowed values are 1-64. Unit is KB. Allowed with any value in Enterprise, Basic, Enterprise with Cloud Services edition. Allowed in Essentials (Allowed values- 12) edition.
	...
	// Close server-side connection when an error response is received. Field introduced in 30.2.1. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
	...
	// HTTP Compression settings to use with this HTTP Profile. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
	...
	// Detect NTLM apps based on the HTTP Response from the server. Once detected, connection multiplexing will be disabled for that connection. Field introduced in 20.1.3. Allowed with any value in Enterprise, Basic, Enterprise with Cloud Services edition.
	...
	// Enable request body buffering for POST requests. If enabled, max buffer size is set to lower of 32M or the value (non-zero) configured in client_max_body_size. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Forward the Connection  Close header coming from backend server to the client if connection-switching is enabled, i.e. front-end and backend connections are bound together. Field introduced in 18.2.3. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Number of days for which the client should regard this virtual service as a known HSTS host. Allowed values are 0-10000. Allowed with any value in Enterprise, Enterprise with Cloud Services edition. Allowed in Essentials (Allowed values- 365), Basic (Allowed values- 365) edition.
	...
	// Specifies the HTTP/2 specific application profile parameters. Field introduced in 18.2.10, 20.1.1. Allowed with any value in Enterprise, Basic, Enterprise with Cloud Services edition.
	Http2Profile *Http2ApplicationProfile `json:"http2_profile,omitempty"`

	// Client requests received via HTTP will be redirected to HTTPS. Allowed with any value in Enterprise, Basic, Enterprise with Cloud Services edition. Allowed in Essentials (Allowed values- false) edition.
	HTTPToHTTPS *bool `json:"http_to_https,omitempty"`

	// Size of HTTP buffer in kB. Allowed values are 1-256. Special values are 0- Auto compute the size of buffer. Field introduced in 20.1.1. Unit is KB. Allowed with any value in Enterprise, Enterprise with Cloud Services edition. Allowed in Essentials (Allowed values- 0), Basic (Allowed values- 0) edition.
	...
	// The max idle time allowed between HTTP requests over a Keep-alive connection. Allowed values are 10-100000000. Unit is MILLISECONDS. Allowed with any value in Enterprise, Basic, Enterprise with Cloud Services edition. Allowed in Essentials (Allowed values- 30000) edition.
	KeepaliveTimeout *int32 `json:"keepalive_timeout,omitempty"`

	// Maximum bad requests per second per client IP. Allowed values are 10-1000. Special values are 0- unlimited. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	MaxBadRpsCip *uint32 `json:"max_bad_rps_cip,omitempty"`

	// Maximum bad requests per second per client IP and URI. Allowed values are 10-1000. Special values are 0- unlimited. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	MaxBadRpsCipURI *uint32 `json:"max_bad_rps_cip_uri,omitempty"`

	// Maximum bad requests per second per URI. Allowed values are 10-1000. Special values are 0- unlimited. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	MaxBadRpsURI *uint32 `json:"max_bad_rps_uri,omitempty"`

	// Maximum number of headers allowed in HTTP request and response. Allowed values are 0-4096. Special values are 0- unlimited headers in request and response. Field introduced in 22.1.1. Allowed with any value in Enterprise, Enterprise with Cloud Services edition. Allowed in Essentials (Allowed values- 0), Basic (Allowed values- 0) edition. Special default for Essentials edition is 0, Basic edition is 0, Enterprise edition is 256.
	...
	// Maximum size in Kbytes of all the HTTP response headers. Allowed values are 1-256. Unit is KB. Allowed with any value in Enterprise, Basic, Enterprise with Cloud Services edition. Allowed in Essentials (Allowed values- 48) edition.
	MaxResponseHeadersSize *int32 `json:"max_response_headers_size,omitempty"`

	// Maximum requests per second per client IP. Allowed values are 10-1000. Special values are 0- unlimited. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	MaxRpsCip *uint32 `json:"max_rps_cip,omitempty"`

	// Maximum requests per second per client IP and URI. Allowed values are 10-1000. Special values are 0- unlimited. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	MaxRpsCipURI *uint32 `json:"max_rps_cip_uri,omitempty"`

	// Maximum unknown client IPs per second. Allowed values are 10-1000. Special values are 0- unlimited. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	MaxRpsUnknownCip *uint32 `json:"max_rps_unknown_cip,omitempty"`

	// Maximum unknown URIs per second. Allowed values are 10-1000. Special values are 0- unlimited. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	MaxRpsUnknownURI *uint32 `json:"max_rps_unknown_uri,omitempty"`

	// Maximum requests per second per URI. Allowed values are 10-1000. Special values are 0- unlimited. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	MaxRpsURI *uint32 `json:"max_rps_uri,omitempty"`

	// Pass through X-ACCEL headers. Field introduced in 21.1.3. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
	...
	// The max allowed length of time between a client establishing a TCP connection and Avi receives the first byte of the client's HTTP request. Allowed values are 10-100000000. Unit is MILLISECONDS. Allowed with any value in Enterprise, Enterprise with Cloud Services edition. Allowed in Essentials (Allowed values- 30000), Basic (Allowed values- 30000) edition.
	PostAcceptTimeout *int32 `json:"post_accept_timeout,omitempty"`

	// If enabled, an HTTP request on an SSL port will result in connection close instead of a 400 response. Field introduced in 18.2.6. Allowed with any value in Enterprise, Enterprise with Cloud Services edition. Allowed in Essentials (Allowed values- false), Basic (Allowed values- false) edition.
	ResetConnHTTPOnSslPort *bool `json:"reset_conn_http_on_ssl_port,omitempty"`

	// Avi will respond with 100-Continue response if Expect  100-Continue header received from client. Field introduced in 17.2.8. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// HTTP session configuration. Field introduced in 30.2.1. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
	SessionConfig *HttpsessionConfig `json:"session_config,omitempty"`

	// Set of match/action rules that govern what happens when the client certificate request is enabled. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
	SslClientCertificateAction *SSLClientCertificateAction `json:"ssl_client_certificate_action,omitempty"`

	// Specifies whether the client side verification is set to none, request or require. Enum options - SSL_CLIENT_CERTIFICATE_NONE, SSL_CLIENT_CERTIFICATE_REQUEST, SSL_CLIENT_CERTIFICATE_REQUIRE. Allowed with any value in Enterprise, Enterprise with Cloud Services edition. Allowed in Essentials (Allowed values- SSL_CLIENT_CERTIFICATE_NONE,SSL_CLIENT_CERTIFICATE_REQUIRE), Basic (Allowed values- SSL_CLIENT_CERTIFICATE_NONE,SSL_CLIENT_CERTIFICATE_REQUIRE) edition.
	SslClientCertificateMode *string `json:"ssl_client_certificate_mode,omitempty"`

	// Detect client IP from user specified header at the configured index in the specified direction. Field introduced in 21.1.3. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
	TrueClientIP *TrueClientIPConfig `json:"true_client_ip,omitempty"`

	// Use 'Keep-Alive' header timeout sent by application instead of sending the HTTP Keep-Alive Timeout. Allowed with any value in Enterprise, Enterprise with Cloud Services edition. Allowed in Essentials (Allowed values- false), Basic (Allowed values- false) edition.
	UseAppKeepaliveTimeout *bool `json:"use_app_keepalive_timeout,omitempty"`

	// Detect client IP from user specified header. Field introduced in 21.1.3. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
	UseTrueClientIP *bool `json:"use_true_client_ip,omitempty"`

	// Enable Websockets proxy for traffic from clients to the virtual service. Connections to this VS start in HTTP mode. If the client requests an Upgrade to Websockets, and the server responds back with success, then the connection is upgraded to WebSockets mode. . Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Provide a custom name for the X-Forwarded-For header sent to the servers. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	XffAlternateName *string `json:"xff_alternate_name,omitempty"`

	// The client's original IP address is inserted into an HTTP request header sent to the server.  Servers may use this address for logging or other purposes, rather than Avi's source NAT address used in the Avi to server IP connection. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	XffEnabled *bool `json:"xff_enabled,omitempty"`

	// Configure how incoming X-Forwarded-For headers from the client are handled. Enum options - REPLACE_XFF_HEADERS, APPEND_TO_THE_XFF_HEADER, ADD_NEW_XFF_HEADER. Field introduced in 22.1.3. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
