...
type UserActivity struct {
	...
	// Number of concurrent user sessions open. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	ConcurrentSessions *uint32 `json:"concurrent_sessions,omitempty"`

	// Number of failed login attempts before a successful login. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	FailedLoginAttempts *uint32 `json:"failed_login_attempts,omitempty"`

	// IP of the machine the user was last logged in from. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	LastLoginIP *string `json:"last_login_ip,omitempty"`

	// Timestamp of last login. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	LastLoginTimestamp *string `json:"last_login_timestamp,omitempty"`

	// Timestamp of last password update. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
