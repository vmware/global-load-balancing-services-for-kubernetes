...
type SSLCipherList struct {
	...
	// List of ciphers from the client's SSL cipher list, that could not be identified. The ciphers are represented by their RFC 2 byte hex value. Field introduced in 18.1.4, 18.2.1. Maximum of 255 items allowed. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
