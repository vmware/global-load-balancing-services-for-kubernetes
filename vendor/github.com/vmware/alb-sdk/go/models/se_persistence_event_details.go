...
type SePersistenceEventDetails struct {
	...
	// Current number of entries in the client ip persistence table. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	Entries *int32 `json:"entries,omitempty"`

	// Name of pool whose persistence table limits were reached. It is a reference to an object of type Pool. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
