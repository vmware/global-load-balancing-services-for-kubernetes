...
type SeAgentStateCacheProperties struct {
	...
	// Max elements to dequeue in one shot from the Q by the statecache thread. Allowed values are 1-10000. Field introduced in 21.1.1.
	ScCfgQBatchDequeueLimit *int32 `json:"sc_cfg_q_batch_dequeue_limit,omitempty"`

	// Max elements in the config queue between seagent main and the statecache thread. Allowed values are 1-10000. Field introduced in 21.1.1.
	ScCfgQMaxSize *int32 `json:"sc_cfg_q_max_size,omitempty"`
	...
	// Interval for update of operational states to controller. Allowed values are 1-10000. Field introduced in 18.2.5. Unit is MILLISECONDS.
	ScStatesFlushInterval *int32 `json:"sc_states_flush_interval,omitempty"`

	// Interval for checking health of grpc streams to statecache_mgr. Allowed values are 1-90000. Field introduced in 18.2.5. Unit is MILLISECONDS.
	...
	// Interval for grpc thread to sleep between doing work. Allowed values are 1-10000. Field introduced in 18.2.5. Unit is MILLISECONDS.
