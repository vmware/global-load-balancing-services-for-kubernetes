...
type UpgradeReadinessCheckObj struct {
	...
	// The Upgrade readiness check operations current fsm-state. Field introduced in 22.1.3. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
