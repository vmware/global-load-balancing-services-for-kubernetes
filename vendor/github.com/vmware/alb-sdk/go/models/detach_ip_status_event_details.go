...
// DetachIPStatusEventDetails detach Ip status event details
// swagger:model DetachIpStatusEventDetails
type DetachIPStatusEventDetails struct {

	// Reason if Detach IP failed. Field introduced in 21.1.3. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
