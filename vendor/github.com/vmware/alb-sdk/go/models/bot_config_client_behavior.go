...
type BotConfigClientBehavior struct {
	...
	// Minimum percentage of bad requests for the client behavior component to identify as a bot. Allowed values are 1-100. Field introduced in 30.2.1. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
	BadRequestPercent *uint32 `json:"bad_request_percent,omitempty"`

	// Whether client behavior based Bot detection is enabled. Field introduced in 30.2.1. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
	Enabled *bool `json:"enabled,omitempty"`

	// Minimum requests for the client behavior component to make a decision. Allowed values are 2-1000. Field introduced in 30.2.1. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
