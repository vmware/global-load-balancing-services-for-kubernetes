...
type HealthMonitor struct {
	...
	// Destination IP Address to be monitored instead of the pool member IP. Field introduced in 31.2.1. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
	MonitorIP *IPAddr `json:"monitor_ip,omitempty"`
