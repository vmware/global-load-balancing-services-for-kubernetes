...
type SeRuntimeProperties struct {
	...
	// Consecutive HB failures after which failure is reported to controller, when aggressive failure mode detection is not enabled. (This field has been moved to se_group properties 20.1.3 onwards). Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	DpHbTimeoutCount *uint32 `json:"dp_hb_timeout_count,omitempty"`

	// Frequency of ARP requests sent by SE for each VIP to detect duplicate IP when it loses conectivity to controller. Unit is MILLISECONDS. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	DupipFrequency *uint32 `json:"dupip_frequency,omitempty"`

	// Number of ARP responses received for the VIP after which SE decides that the VIP has been moved and disables the VIP. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	DupipTimeoutCount *uint32 `json:"dupip_timeout_count,omitempty"`

	// Enable HSM luna engine logs. Field introduced in 16.4.8, 17.1.11, 17.2.3. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// How often to push the flow table IPC messages in the main loop. The value is the number of times through the loop before pushing the batch. i.e, a value of 1 means every time through the loop. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Maximum retries per request in the request queue. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	LbactionRqPerRequestMaxRetries *uint32 `json:"lbaction_rq_per_request_max_retries,omitempty"`

	// Deprecated in 21.1.1. Flag to indicate if log files are compressed upon full on the Service Engine. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	LogAgentCompressLogs *bool `json:"log_agent_compress_logs,omitempty"`

	// Deprecated in 21.1.1. Maximum application log file size before rollover. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	LogAgentFileSzAppl *uint32 `json:"log_agent_file_sz_appl,omitempty"`

	// Deprecated in 21.1.1. Maximum connection log file size before rollover. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	LogAgentFileSzConn *uint32 `json:"log_agent_file_sz_conn,omitempty"`

	// Deprecated in 21.1.1. Maximum debug log file size before rollover. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	LogAgentFileSzDebug *uint32 `json:"log_agent_file_sz_debug,omitempty"`

	// Deprecated in 21.1.1. Maximum event log file size before rollover. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Deprecated in 21.1.1. Excess percentage threshold of disk size to trigger cleanup of logs on the Service Engine. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Deprecated in 21.1.1. Internal timer to stall log-agent and prevent it from hogging CPU cycles on the Service Engine. Unit is MILLISECONDS. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	LogAgentSleepInterval *uint32 `json:"log_agent_sleep_interval,omitempty"`

	// Deprecated in 21.1.1. Timeout to purge unknown Virtual Service logs from the Service Engine. Unit is SEC. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	LogAgentUnknownVsTimer *uint32 `json:"log_agent_unknown_vs_timer,omitempty"`

	// Deprecated in 21.1.1. Maximum number of file names in a log message. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Maximum memory in bytes allocated for persistence entries. Allowed values are 0-33554432. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	PersistenceMemMax *uint32 `json:"persistence_mem_max,omitempty"`

	// Enable punting of UDP packets from primary to other Service Engines. This applies to Virtual Services with Per-Packet Loadbalancing enabled. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	ScaleoutUDPPerPkt *bool `json:"scaleout_udp_per_pkt,omitempty"`

	// LDAP basicauth default bind timeout enforced on connections to LDAP server. Unit is MILLISECONDS. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	SeAuthLdapBindTimeout *uint32 `json:"se_auth_ldap_bind_timeout,omitempty"`

	// Size of LDAP basicauth credentials cache used on the dataplane. Unit is BYTES. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	SeAuthLdapCacheSize *uint32 `json:"se_auth_ldap_cache_size,omitempty"`

	// LDAP basicauth default connection timeout enforced on connections to LDAP server. Unit is MILLISECONDS. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	SeAuthLdapConnectTimeout *uint32 `json:"se_auth_ldap_connect_timeout,omitempty"`

	// Number of concurrent connections to LDAP server by a single basic auth LDAP process. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	SeAuthLdapConnsPerServer *uint32 `json:"se_auth_ldap_conns_per_server,omitempty"`

	// LDAP basicauth default reconnect timeout enforced on connections to LDAP server. Unit is MILLISECONDS. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	SeAuthLdapReconnectTimeout *uint32 `json:"se_auth_ldap_reconnect_timeout,omitempty"`

	// LDAP basicauth default login or group search request timeout enforced on connections to LDAP server. Unit is MILLISECONDS. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Deprecated in 21.1.1. Internal buffer full indicator on the Service Engine beyond which the unfiltered logs are abandoned. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	SeDpLogNfEnqueuePercent *uint32 `json:"se_dp_log_nf_enqueue_percent,omitempty"`

	// Deprecated in 21.1.1. Internal buffer full indicator on the Service Engine beyond which the user filtered logs are abandoned. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	SeDpLogUdfEnqueuePercent *uint32 `json:"se_dp_log_udf_enqueue_percent,omitempty"`

	// Deprecated in 21.1.3. Use config in ServiceEngineGroup instead. Field introduced in 18.1.3, 18.2.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	SeDumpCoreOnAssert *bool `json:"se_dump_core_on_assert,omitempty"`

	// Accept/ignore interface routes (i.e, no next hop IP address). Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	SeHandleInterfaceRoutes *bool `json:"se_handle_interface_routes,omitempty"`

	// Internal use only. Allowed values are 0-7. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	SeHbPersistFudgeBits *uint32 `json:"se_hb_persist_fudge_bits,omitempty"`

	// Number of packets with wrong mac after which SE attempts to disable promiscious mode. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Port ranges on which there may be virtual services (for configuring iptables). Applicable in container ecosystems like Mesos. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	ServicePortRanges []*PortRange `json:"service_port_ranges,omitempty"`

	// Make service ports accessible on all Host interfaces in addition to East-West VIP and/or bridge IP. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	ServicesAccessibleAllInterfaces *bool `json:"services_accessible_all_interfaces,omitempty"`

	// Default value for max number of retransmissions for a SYN packet. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	TCPSyncacheMaxRetransmitDefault *uint32 `json:"tcp_syncache_max_retransmit_default,omitempty"`

	// Timeout for backend connection. Unit is MILLISECONDS. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	UpstreamConnectTimeout *uint32 `json:"upstream_connect_timeout,omitempty"`

	// L7 Upstream Connection pool cache threshold in percentage. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Enable upstream connection pool. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
