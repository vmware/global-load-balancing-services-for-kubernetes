...
type MetricsDbSyncFailureEventDetails struct {
	...
	// Name of the node responsible for this event. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	NodeName *string `json:"node_name,omitempty"`

	// Name of the process responsible for this event. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
