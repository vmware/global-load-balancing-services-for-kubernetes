...
type SeGroupAnalyticsPolicy struct {
	...
	// Thresholds for various events generated by metrics system. Field introduced in 20.1.3. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
