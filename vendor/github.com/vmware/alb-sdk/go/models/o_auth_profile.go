...
type OAuthProfile struct {
	...
	// Uniquely identifiable name of the Token Issuer. Field introduced in 21.1.3. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
	Issuer *string `json:"issuer,omitempty"`

	// Lifetime of the cached JWKS keys. Allowed values are 0-1440. Field introduced in 21.1.3. Unit is MIN. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
	JwksTimeout *int32 `json:"jwks_timeout,omitempty"`

	// JWKS URL of the endpoint that hosts the public keys that can be used to verify any JWT issued by the authorization server. Field introduced in 21.1.3. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
	JwksURI *string `json:"jwks_uri,omitempty"`

	// OAuth App Settings for controller authentication. Field introduced in 30.1.1. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
	...
	// URL of the Userinfo Endpoint. Field introduced in 21.1.3. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
