...
import (
	// mciapi "github.com/vmware/load-balancer-and-ingress-services-for-kubernetes/pkg/apis/amko/v1alpha1"
	"context"
	"encoding/json"
	"fmt"

	"github.com/golang/glog"
	sics "github.com/vmware/load-balancer-and-ingress-services-for-kubernetes/pkg/client/v1alpha1/clientset/versioned"
	...
	sischeme "github.com/vmware/load-balancer-and-ingress-services-for-kubernetes/pkg/client/v1alpha1/clientset/versioned/scheme"
	siinformers "github.com/vmware/load-balancer-and-ingress-services-for-kubernetes/pkg/client/v1alpha1/informers/externalversions"
	silisters "github.com/vmware/load-balancer-and-ingress-services-for-kubernetes/pkg/client/v1alpha1/listers/ako/v1alpha1"
...
func InitializeServiceImportController(kubeClient *kubernetes.Clientset, siClient *sics.Clientset,
	...
	siInformer := siInformerFactory.Ako().V1alpha1().ServiceImports()
...
func (siController *ServiceImportController) UpdateServiceImportObj(obj *siapi.ServiceImport) error {
	...
	if _, err := siController.siClientset.AkoV1alpha1().ServiceImports(obj.GetNamespace()).Patch(context.TODO(),
...
func (siController *ServiceImportController) CreateServiceImportObj(obj *siapi.ServiceImport) error {
	if _, err := siController.siClientset.AkoV1alpha1().ServiceImports(obj.GetNamespace()).Create(context.TODO(),
...
func (siController *ServiceImportController) DeleteServiceImportObject(ns, name string) error {
	if err := siController.siClientset.AkoV1alpha1().ServiceImports(ns).Delete(context.TODO(),
