...
ROOT_FOLDER_BUILDS_ARCHIVAL = '/mnt/builds/amko_OS'
...
def _get_build_version(build_number):
    ...
    checked out amko repository branch
...
def _get_branch_version():
    """ Retrieves the branch version string for the currently checked out amko
    repository branch
...
def _get_branch_builds_location(branch_name):
    ...
    :param branch_name: Name of the amko GIT repository branch
    """
...
def _get_branch_build_location(branch_name, build_number):
    ...
    :param branch_name: name of the amko GIT branch
...
'''
    ...
    parser.add_argument('-b', '--branch-name',
                        required=True,
                        action='store',
                        help="Name of the amko GIT repository branch")
