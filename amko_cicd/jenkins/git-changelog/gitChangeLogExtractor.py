...
def print_commits_details():
    ...
    if all_commits:
        for all_commit in all_commits:
            all_commit['id'] = "https://github.com/vmware/global-load-balancing-services-for-kubernetes/commit/{}".format(all_commit['id'])
...
def get_commit_table_details():
    ...
    for commit in all_commits:
        commit_id = commit['id']
        commit_url = "https://github.com/vmware/global-load-balancing-services-for-kubernetes/commit/{}/".format(
                        commit_id)
        ...
        for commit_path_detail in commit['paths']:
            ...
            blob_url = "https://github.com/vmware/global-load-balancing-services-for-kubernetes/blob/{}/{}".format(
                            commit_id, file_path)
...
def get_all_chart_details():
    ...
    if all_commits:
        ...
        _get_commit_url = lambda commit_id: 'https://github.com/vmware/global-load-balancing-services-for-kubernetes/commit/{}/'.format(commit_id)
