...
import (
	...
	"github.com/vmware/global-load-balancing-services-for-kubernetes/internal/client/v1alpha1/clientset/versioned/scheme"
...
func (c *AmkoV1alpha1Client) ServiceImports(namespace string) ServiceImportInterface {
